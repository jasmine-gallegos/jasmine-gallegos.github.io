...
import { type Genre } from "../content/projects"
...
function HomePage() {
  ...
  const categories: {genre: Genre, label: string, index: number}[] = [
    ...
    <>
      ...
      ">
        ...
        <div className="
          ...
          mr-14 ml-14
          ">
            {allProjectsList.filter( (proj) => proj.genre === categories[currentCategory].genre || currentCategory === 0 ).map((p, i) => (
